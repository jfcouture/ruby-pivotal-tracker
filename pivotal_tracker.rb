...
module Pivotal
  class Tracker
    ...
    def initialize(project_id, token, ssl=true)
  ...
  private
    ...
    def validate_response(body)
      response = Hpricot(body).at('message')
      if response      
        raise TrackerException.new(response.innerHTML)
      end
    end
  ...
  class TrackerException < StandardError
  end
end